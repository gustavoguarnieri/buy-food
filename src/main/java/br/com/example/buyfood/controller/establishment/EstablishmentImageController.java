...
public class EstablishmentImageController {
  ...
  @Autowired private EstablishmentImageService establishmentImageService;
  ...
  public List<ImageResponseDTO> getEstablishmentImageList(
    ...
    log.info(
        "getEstablishmentImageList: starting to consult the list of establishment image, establishmentId={}",
        establishmentId);
    var imageResponseDto =
        establishmentImageService.getEstablishmentImageList(establishmentId, status);
    log.info(
        "getEstablishmentImageList: finished to consult the list of establishment image, establishmentId={}",
        establishmentId);
  ...
  public ImageResponseDTO getEstablishmentImage(
      @Valid @NotBlank @PathVariable("establishmentId") Long establishmentId,
      @Valid @NotBlank @PathVariable("imageId") Long imageId) {
    log.info(
        "getEstablishmentImage: starting to consult establishment image by establishmentId={}, imageId={}",
        establishmentId,
        imageId);
    var imageResponseDto =
        establishmentImageService.getEstablishmentImage(establishmentId, imageId);
    log.info(
        "getEstablishmentImage: finished to consult establishment image by establishmentId={}, imageId={}",
        establishmentId,
        imageId);
    return imageResponseDto;
  }
  ...
  public ImageResponseDTO createEstablishmentImage(
      @Valid @NotBlank @PathVariable("establishmentId") Long establishmentId,
      @RequestParam MultipartFile file) {
    log.info(
        "createEstablishmentImage: starting to create new establishment image, establishmentId={}",
        establishmentId);
    var productImageResponseDto =
        establishmentImageService.createEstablishmentImage(establishmentId, file);
    log.info(
        "createEstablishmentImage: finished to create new establishment image, establishmentId={}",
        establishmentId);
  ...
  public List<ImageResponseDTO> createEstablishmentImages(
    ...
    log.info(
        "createEstablishmentImages: starting to create new establishment images, establishmentId={}",
        establishmentId);
    var imageResponseDtoList =
        establishmentImageService.createEstablishmentImageList(establishmentId, files);
    log.info(
        "createEstablishmentImages: finished to create new establishment images, establishmentId={}",
        establishmentId);
  ...
  public void updateEstablishmentImage(
    ...
    log.info(
        "updateEstablishmentImage: starting update establishment image by establishmentId={}, imageId={}",
        establishmentId,
        imageId);
    establishmentImageService.updateEstablishmentImage(establishmentId, imageId, imageRequestDto);
    log.info(
        "updateEstablishmentImage: finished update establishment image by establishmentId={}, imageId={}",
        establishmentId,
        imageId);
  }
  ...
  public void deleteEstablishmentImage(
      @Valid @NotBlank @PathVariable("establishmentId") Long establishmentId,
      @Valid @NotBlank @PathVariable("imageId") Long imageId) {
    log.info(
        "deleteEstablishmentImage: starting delete establishment image establishmentId={}, imageId={}",
        establishmentId,
        imageId);
    establishmentImageService.deleteEstablishmentImage(establishmentId, imageId);
    log.info(
        "deleteEstablishmentImage: finished delete establishment image establishmentId={}, imageId={}",
        establishmentId,
        imageId);
  }
}
