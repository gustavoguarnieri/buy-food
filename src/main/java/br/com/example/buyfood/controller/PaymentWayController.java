...
public class PaymentWayController {
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Returns a list of payment way",
                    response = PaymentWayResponseDTO.class, responseContainer = "List"),
    ...
    public List<PaymentWayResponseDTO> getPaymentWayList(
        ...
        var paymentWayResponseDtoList =
                paymentWayService.getPaymentWayList(status);
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Returns the informed payment way",
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 201, message = "Created payment way",
                    response = PaymentWayResponseDTO.class),
            @ApiResponse(code = 401, message = "You are unauthorized to access this resource"),
            @ApiResponse(code = 403, message = "You do not have permission to access this resource"),
            @ApiResponse(code = 500, message = "An exception was thrown"),
    ...
    public PaymentWayResponseDTO createPaymentWay(
        ...
        var paymentWayResponseDto =
                paymentWayService.createPaymentWay(paymentWayRequestDTO);
    ...
    public void updatePaymentWay(@Valid @NotBlank @PathVariable("id") Long id,
                                 @Valid @RequestBody PaymentWayRequestDTO paymentWayRequestDTO) {
