...
public class EstablishmentDeliveryTaxController {
  ...
  @Autowired private EstablishmentDeliveryTaxService establishmentDeliveryTaxService;
  ...
  public List<EstablishmentDeliveryTaxResponseDTO> getDeliveryTaxList(
      @RequestParam(required = false) Integer status) {
    log.info("getDeliveryTaxList: starting to consult the list of delivery tax");
    var deliveryTaxResponseDto = establishmentDeliveryTaxService.getDeliveryTaxList(status);
  ...
  public EstablishmentDeliveryTaxResponseDTO getDeliveryTax(
    ...
    var deliveryTaxResponseDto = establishmentDeliveryTaxService.getDeliveryTax(deliveryTaxId);
  ...
  public List<EstablishmentDeliveryTaxResponseDTO> getMyDeliveryTax(
      @RequestParam(required = false) Integer status) {
    log.info("getMyDeliveryTax: starting to consult the list of my delivery tax");
    var deliveryTaxResponseDto = establishmentDeliveryTaxService.getMyDeliveryTaxList(status);
  ...
  public EstablishmentDeliveryTaxResponseDTO createDeliveryTax(
      @Valid @RequestBody EstablishmentDeliveryTaxRequestDTO establishmentDeliveryTaxRequestDto) {

    log.info("createDeliveryTax: starting to create new delivery tax");
    var deliveryTaxResponseDto =
        establishmentDeliveryTaxService.createDeliveryTax(establishmentDeliveryTaxRequestDto);
  ...
  public void updateDeliveryTax(
    ...
    establishmentDeliveryTaxService.updateDeliveryTax(
        deliveryTaxId, establishmentDeliveryTaxPutRequestDto);
