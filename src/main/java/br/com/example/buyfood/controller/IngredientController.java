...
public class IngredientController {
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Returns a ingredient list of product",
    ...
    public List<IngredientResponseDTO> getIngredientList(
        ...
        log.info("getIngredientList: starting to consult the ingredient list establishmentId={} productId={}, " +
                "status={}", establishmentId, productId, status);
        var ingredientResponseDtoList =
                ingredientService.getIngredientList(establishmentId, productId, status);
        log.info("getIngredientList: finished to consult the ingredient list establishmentId={}, productId={}, " +
                "status={}", establishmentId, productId, status);
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Returns the informed ingredient",
                    response = IngredientResponseDTO.class),
            @ApiResponse(code = 401, message = "You are unauthorized to access this resource"),
            @ApiResponse(code = 403, message = "You do not have permission to access this resource"),
            @ApiResponse(code = 500, message = "An exception was thrown"),
    })
    public IngredientResponseDTO getIngredient(@Valid @NotBlank @PathVariable("establishmentId") Long establishmentId,
                                               @Valid @NotBlank @PathVariable("productId") Long productId,
                                               @Valid @NotBlank @PathVariable("ingredientId") Long ingredientId) {
        log.info("getIngredient: starting to consult ingredient by establishmentId={}, productId={}, ingredientId={}",
        ...
        log.info("getIngredient: finished to consult ingredient by establishmentId={}, productId={}, ingredientId={}",
                establishmentId, productId, ingredientId);
    ...
    public IngredientResponseDTO createIngredient(
        ...
        log.info("createIngredient: starting to create new ingredient by establishmentId={}, productId={}",
                establishmentId, productId);
        var ingredientResponseDto =
                ingredientService.createIngredient(establishmentId, productId, ingredientRequestDTO);
        log.info("createIngredient: finished to create new ingredient by establishmentId={}, productId={}",
                establishmentId, productId);
        return ingredientResponseDto;
    }
    ...
    public void updateIngredient(@Valid @NotBlank @PathVariable("establishmentId") Long establishmentId,
                                 @Valid @NotBlank @PathVariable("productId") Long productId,
                                 @Valid @NotBlank @PathVariable("ingredientId") Long ingredientId,
                                 @Valid @RequestBody IngredientRequestDTO ingredientRequestDTO) {
        log.info("updateIngredient: starting update ingredient establishmentId={}, productId={}, ingredientId={}",
                establishmentId, productId, ingredientId);
        ingredientService.updateIngredient(establishmentId, productId, ingredientId, ingredientRequestDTO);
        log.info("updateIngredient: finished update ingredient establishmentId={}, productId={}, ingredientId={}",
                establishmentId, productId, ingredientId);
    }
    ...
    public void deleteIngredient(@Valid @NotBlank @PathVariable("establishmentId") Long establishmentId,
                                 @Valid @NotBlank @PathVariable("productId") Long productId,
                                 @Valid @NotBlank @PathVariable("ingredientId") Long ingredientId) {
        log.info("deleteIngredient: starting delete ingredient establishmentId={}, productId={}, ingredientId={}",
                establishmentId, productId, ingredientId);
        ingredientService.deleteIngredient(establishmentId, productId, ingredientId);
        log.info("deleteIngredient: finished delete ingredient establishmentId={}, productId={}, ingredientId={}",
                establishmentId, productId, ingredientId);
    }
}