...
public class EstablishmentBusinessHoursController {
  ...
  @Autowired private EstablishmentBusinessHoursService establishmentBusinessHoursService;
  ...
  public List<EstablishmentBusinessHoursResponseDTO> getBusinessHoursList(
    ...
    log.info(
        "getBusinessHoursList: starting to consult the list of business hours, "
            + "establishmentId={}",
        establishmentId);
  ...
  public EstablishmentBusinessHoursResponseDTO getBusinessHours(
    ...
    log.info(
        "getBusinessHours: starting to consult business hours by establishmentId={}, businessHoursId={}",
        establishmentId,
        businessHoursId);
    var businessHoursResponseDto =
        establishmentBusinessHoursService.getBusinessHours(establishmentId, businessHoursId);
    log.info(
        "getBusinessHours: finished to consult business hours by establishmentId={}, businessHoursId={}",
        establishmentId,
        businessHoursId);
  ...
  public List<EstablishmentBusinessHoursResponseDTO> getMyBusinessHoursList(
      @RequestParam(required = false) Integer status) {
  ...
  public void deleteBusinessHours(
    ...
    log.info(
        "deleteBusinessHours: starting delete business hours establishmentId={}, businessHoursId={}",
        establishmentId,
        businessHoursId);
    establishmentBusinessHoursService.deleteBusinessHours(establishmentId, businessHoursId);
    log.info(
        "deleteBusinessHours: finished delete business hours establishmentId={}, businessHoursId={}",
        establishmentId,
        businessHoursId);
  }
}
