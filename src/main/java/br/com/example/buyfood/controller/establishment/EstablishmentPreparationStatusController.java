...
public class EstablishmentPreparationStatusController {
  ...
  public PreparationStatusResponseDTO getPreparationStatus(
      @Valid @NotBlank @PathVariable("id") Long id) {
    log.info("getPreparationStatus: starting to consult preparation status by id={}", id);
    var preparationStatusResponseDto = preparationStatusService.getPreparationStatus(id);
