...
public class DashboardController {
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Returns a list of orders by month",
                    response = DashboardStatisticsInterface.class, responseContainer = "List"),
    ...
    public List<DashboardStatisticsInterface> getOrdersByMonthList() {
        ...
        var ordersByMonthResponseDto =
                dashboardService.getOrdersByMonthList();
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Returns a list of billing by month",
                    response = DashboardStatisticsInterface.class, responseContainer = "List"),
            @ApiResponse(code = 401, message = "You are unauthorized to access this resource"),
            @ApiResponse(code = 403, message = "You do not have permission to access this resource"),
            @ApiResponse(code = 500, message = "An exception was thrown"),
    ...
    public List<DashboardStatisticsInterface> getBillingByMonthList() {
        ...
        var billingByMonthList =
                dashboardService.getBillingByMonthList();
    ...
    public List<DashboardStatisticsInterface> getPreparationStatusList() {
        ...
        var preparationStatusList =
                dashboardService.getPreparationStatusList();
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Returns a list of payment way",
                    response = DashboardStatisticsInterface.class, responseContainer = "List"),
            @ApiResponse(code = 401, message = "You are unauthorized to access this resource"),
            @ApiResponse(code = 403, message = "You do not have permission to access this resource"),
            @ApiResponse(code = 500, message = "An exception was thrown"),
    ...
    public List<DashboardStatisticsInterface> getPaymentWayList() {
        ...
        var paymentWayList =
                dashboardService.getPaymentWayList();
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Returns a list of declined status",
                    response = DashboardStatisticsInterface.class, responseContainer = "List"),
            @ApiResponse(code = 401, message = "You are unauthorized to access this resource"),
            @ApiResponse(code = 403, message = "You do not have permission to access this resource"),
            @ApiResponse(code = 500, message = "An exception was thrown"),
    ...
    public List<DashboardStatisticsInterface> getPaymentDeclinedStatusList() {
        ...
        var paymentDeclinedStatusList =
                dashboardService.getPaymentDeclinedStatusList();
