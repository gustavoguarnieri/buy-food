...
public class FileStorageService {
    ...
    private static final String FILE_NAME_TEXT = "filename=";
    ...
    public UploadFileResponseDTO saveFile(
        ...
        try {
            ...
            throw new FileStorageException(ErrorMessages.COULD_NOT_STORE_FILE + " " + FILE_NAME_TEXT + " " + fileName);
        }
    ...
    public Resource loadFileAsResource(
        ...
        try {
            ...
            throw new FileNotFoundException(ErrorMessages.FILE_NOT_FOUND + " " + FILE_NAME_TEXT + " " + fileName);
        }
    }
