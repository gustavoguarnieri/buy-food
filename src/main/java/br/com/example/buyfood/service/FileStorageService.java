...
public class FileStorageService {
    ...
    private void isValidFilePath(String fileName) {
        if (fileName.contains("..")) {
            throw new FileStorageException(ErrorMessages.INVALID_FILE_NAME_PATH + " filename= " + fileName);
        }
    }
    ...
    public ImageResponseDTO createImageResponseDTO(Long id, UploadFileResponseDTO uploadFileResponse, int status) {
