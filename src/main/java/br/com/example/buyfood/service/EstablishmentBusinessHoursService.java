...
public class EstablishmentBusinessHoursService {
  ...
  public List<EstablishmentBusinessHoursResponseDTO> getBusinessHoursList(
    ...
    if (status == null) {
      ...
      switch (status) {
        case 1:
          return getBusinessHoursListByEstablishmentAndStatus(
              establishment, RegisterStatus.ENABLED);
        case 0:
          {
            return getBusinessHoursListByEstablishmentAndStatus(
                establishment, RegisterStatus.DISABLED);
          }
        default:
  ...
  private List<EstablishmentBusinessHoursResponseDTO>
      getMyBusinessHoursListByAuditCreatedByAndStatus(RegisterStatus enabled) {
    return businessHoursRepository
